...
ifneq ($(BINARY_VERSION),)
	LDFLAGS += -X github.com/jaredallard/k8s-mc-helper/pkg/version.Version=${BINARY_VERSION}
endif

# Clear the "unreleased" string in BuildMetadata
ifneq ($(GIT_TAG),)
	LDFLAGS += -X github.com/jaredallard/k8s-mc-helper/pkg/version.BuildMetadata=
endif
LDFLAGS += -X github.com/jaredallard/k8s-mc-helper/pkg/version.GitCommit=${GIT_COMMIT}
LDFLAGS += -X github.com/jaredallard/k8s-mc-helper/pkg/version.GitTreeState=${GIT_DIRTY}
